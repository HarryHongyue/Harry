      ...
      <div className="neo-footer__grid">
        ...
        <div>
          ...
          <div className="neo-footer__socials">
            ...
            <a className="neo-circle-link" href="https://wa.me/message/OTROOMGVETFGH1" target="_blank" rel="noreferrer" aria-label="WhatsApp">
              <SocialLogo name="whatsapp" size={22} />
            </a>
            <a className="neo-circle-link" href="https://x.com/messages/compose?recipient_id=2055597482466238465" target="_blank" rel="noreferrer" aria-label="XChat">
            ...
            <a className="neo-circle-link" href="https://signal.me/#eu/tirH4v6-G4XbvxicvAdrKr3ef5cO8-QPKOevUDAuhF_ym5b-gzxPxK-O81astj-0" target="_blank" rel="noreferrer" aria-label="Signal">
              <SocialLogo name="signal" size={22} />
            </a>
            <a className="neo-circle-link" href="https://t.me/Omnigent_nl" target="_blank" rel="noreferrer" aria-label="Telegram">
